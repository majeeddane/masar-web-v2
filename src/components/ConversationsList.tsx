      ...
      <div className="p-4 border-b border-gray-100 space-y-4">
        ...
        <div className="flex bg-gray-50 p-1 rounded-xl">
          ...
          <button
            ...
            className={`flex-1 py-1.5 text-sm font-bold rounded-lg transition-all ${filter === 'unread'
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start mb-1">
                    <h3
                      className={`font-bold text-sm truncate ${item.unread_count > 0 ? 'text-gray-900' : 'text-gray-700'
                        }`}
                    >
                  ...
                  <p
                    className={`text-sm truncate ${item.unread_count > 0 ? 'font-bold text-gray-900' : 'text-gray-500'
                      }`}
                  >
